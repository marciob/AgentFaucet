...
export default function DashboardPage() {
  ...
  if (!user) {
    return (
      <main className="min-h-[calc(100vh-4rem)] mx-auto flex max-w-6xl flex-col items-center justify-center px-6 py-32 text-center">
        ...
        <button
          onClick={handleLogin}
          className="mt-6 inline-flex items-center gap-2 rounded-xl bg-accent px-7 py-3.5 text-[15px] font-semibold text-black transition-all hover:bg-accent-hover hover:shadow-[0_0_30px_rgba(240,185,11,0.15)]"
        >
