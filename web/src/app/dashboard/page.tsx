        ...
        <div className="mt-10">
          ...
          <section className="mt-12 animate-in stagger-5 rounded-xl border border-card-border bg-card p-5 sm:p-6">
            ...
            <p className="mt-1 text-sm text-muted">
              Follow these steps to let your agent claim testnet tBNB
              automatically.
            </p>
            ...
            <div className="mt-5 space-y-3">
              <div className="rounded-lg border border-card-border bg-background p-4 transition-colors hover:border-[#2a2a2a]">
                ...
                <p className="mt-2 text-sm text-muted">
                  Claim tBNB to any wallet. The relayer sends the transaction —
                  your agent never needs gas.
                </p>
              ...
              <div className="rounded-lg border border-card-border bg-background p-4 transition-colors hover:border-[#2a2a2a]">
                ...
                <p className="mt-2 text-sm text-muted">
                  Check your tier, daily limit, amount claimed today, and
              ...
              <div className="rounded-lg border border-card-border bg-background p-4 transition-colors hover:border-[#2a2a2a]">
                ...
                <p className="mt-2 text-sm text-muted">
                  Public endpoint — pool balance, total claims, unique
                  developers. No auth required.
                </p>
              </div>
            </div>
